 <link href="../lp1/fonts/font.css" rel="stylesheet" type="text/css">
    <link href="../lp1/css/style.css" rel="stylesheet" type="text/css">
    <link href="../lp1/css/responsive.css" rel="stylesheet" type="text/css">
        ...
        <div class="details_holder">
               <div class="form_content">
                <ul>
                    ...
                    <?php if(!empty($m)): ?>
                    <li><input id="MobilePhone" class="small" name="MobilePhone" type="hidden" value="<?=$m?>" aria-required="true" placeholder="Phone*" required pattern="\d{9,}" title="Must be digit and length is 9" ></li>
                    <?php else: ?>
