<div class="wpb_wrapper">
    <div class="gf_browser_chrome gform_wrapper slider-form_wrapper">
        <form method="post" id="contact" class="slider-form" action="thank-you.php">
            ...
            <div class="gform_footer top_label">
                <input type="submit" id="contact_submit" class="gform_button button" value="Submit">
            </div>
        </form>
    </div>
</div>