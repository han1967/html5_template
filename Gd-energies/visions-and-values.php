															...
															<div class="widget widget_nav_menu">
																<div class="menu-baisc-menu-container">
																	<ul id="menu-baisc-menu" class="menu">
																		...
																		<li id="menu-item-1180" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1180 current-menu-item current_page_item"><a href="visions-and-values.php">Vision and Values</a>
																		</li>
