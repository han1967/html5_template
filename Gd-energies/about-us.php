															...
															<div class="widget widget_nav_menu">
																<div class="menu-baisc-menu-container">
																	<ul id="menu-baisc-menu" class="menu">
																		<li id="menu-item-1178" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-1111 current_page_item menu-item-1178"><a href="https://gd-energies.com/about-us/">About Us</a>
																		</li>
																		<li id="menu-item-1180" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1180"><a href="https://gd-energies.com/visions-and-values/">Vision and Values</a>
																		</li>
																		<li id="menu-item-1179" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1179"><a href="https://gd-energies.com/company-growth/">Company Growth</a>
																		</li>
																		<select>
																			<option selected="selected" value="">Please select another study</option>
																			<option value="https://gd-energies.com/about-us/">About Us</option>
																			<option value="https://gd-energies.com/visions-and-values/">Vision and Values</option>
																			<option value="https://gd-energies.com/company-growth/">Company Growth</option>
																		</select>
																	</ul>
																</div>
															</div>
